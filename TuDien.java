...
public class TuDien {
	...
	public static void main(String args[]) throws IOException {
		...
		while (a != -1) {
			...
			System.out.println("1: Search slang word | 2: Search definition | 3: Show history | 4: Add slangword | 5: Edit slang word");
			System.out.println("6: Delete slang word | 7: Reset lang words | 8: Random slang word | 9: lang word quizz | 10: definition quizz");
